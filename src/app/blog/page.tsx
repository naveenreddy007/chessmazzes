    ...
    <div className="min-h-[85vh] flex flex-col justify-center pt-28 pb-16 sm:pt-36 sm:pb-24">
      <section className="max-w-6xl mx-auto px-6 sm:px-12">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 mb-8">
          ...
          <span className="text-xs font-medium text-white/70 tracking-wide uppercase">Insights</span>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
          {[
            ...
            <div key={post.title} className="glass-card p-8 group hover:border-white/20 transition-all duration-300">
              <span className="text-[10px] font-bold text-blue-electric uppercase tracking-widest mb-4 block">{post.category}</span>
              <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-blue-glow transition-colors">{post.title}</h3>
              <p className="text-white/40 text-sm mb-6 leading-relaxed">{post.excerpt}</p>
        ...
        <div className="text-center py-20 border-t border-white/5">
          ...
          <p className="text-white/40">Subscribe to our newsletter for the latest updates.</p>
        </div>
      </section>
      <FinalCTA />
    </div>
