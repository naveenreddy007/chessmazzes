  ...
  return (
    <div className="min-h-[85vh] flex flex-col justify-center pt-28 pb-16 sm:pt-36 sm:pb-24">
      <section className="max-w-5xl mx-auto px-6 sm:px-12">
        ...
        <p className="text-xl text-foreground/40 mb-16 leading-relaxed max-w-2xl">
        ...
        <div className="space-y-6 mb-20">
          <div className="glass-card p-10 text-center border-dashed border-foreground/10">
            ...
            <p className="text-foreground/40 mb-8 max-w-md mx-auto text-sm leading-relaxed">
        ...
        <div className="grid sm:grid-cols-2 gap-12 pt-20 border-t border-foreground/5">
          <div>
            ...
            <p className="text-foreground/40 text-sm leading-relaxed">Our team is distributed across the globe, working from where they are most productive.</p>
          </div>
          <div>
            <h3 className="text-xl font-bold text-foreground mb-4">Chess Enthusiasts</h3>
            <p className="text-foreground/40 text-sm leading-relaxed">We provide premium memberships to all major chess platforms and support your improvement journey.</p>
          </div>
        </div>
      </section>
    </div>
