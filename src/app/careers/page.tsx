    ...
    <div className="min-h-[85vh] flex flex-col justify-center pt-28 pb-16 sm:pt-36 sm:pb-24">
      <section className="max-w-5xl mx-auto px-6 sm:px-12">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 mb-8">
          ...
          <span className="text-xs font-medium text-white/70 tracking-wide uppercase">Careers</span>
        </div>
        <h1 className="text-5xl font-bold tracking-tight mb-8">Join the <span className="gradient-text">Future of Chess</span></h1>
        <p className="text-xl text-white/40 mb-16 leading-relaxed max-w-2xl">
        ...
        <div className="grid sm:grid-cols-2 gap-12 pt-20 border-t border-white/5">
          <div>
            <h3 className="text-xl font-bold text-white mb-4">Remote First</h3>
            <p className="text-white/40 text-sm leading-relaxed">Our team is distributed across the globe, working from where they are most productive.</p>
          </div>
          <div>
            <h3 className="text-xl font-bold text-white mb-4">Chess Enthusiasts</h3>
            <p className="text-white/40 text-sm leading-relaxed">We provide premium memberships to all major chess platforms and support your improvement journey.</p>
          </div>
        </div>
      </section>
    </div>
