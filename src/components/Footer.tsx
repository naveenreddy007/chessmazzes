...
export default function Footer() {
  return (
    <footer className="relative border-t border-white/5 z-10 bg-[rgba(6,9,15,0.4)] backdrop-blur-md">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28">
        <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/40 leading-relaxed max-w-xs mb-8 text-sm sm:text-base">
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all duration-300"
                >
              ...
              <ul className="space-y-4">
                {links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-sm sm:text-base text-white/30 hover:text-white hover:translate-x-1 inline-block transition-all duration-300"
                    >
                      {link.label}
                    </Link>
                  </li>
          ...
          <div className="lg:col-span-1">
            <h4 className="text-sm font-bold text-white uppercase tracking-widest mb-6">Status</h4>
